...
<body id="ventana" onResize="tamanoVentana()" >
  <!-- Cabecera: -->
   ...
   <div class="contenedor-modulo">
       ...
       <!-- Título módulo: -->
       <div class="titulo-modulo titulo-categoria">
           <h3 id="titulo-modulo"><i class="fa-list"></i>Categorías</h3>
       </div>
       
       <div  class="contenedor-tabla">
          <table>
               <tr class="tabla-categoria">
    ...
    <div id="contenedor-modal" class="contenedor-modal">
        ...
        <div id="hoja-modal" class="hoja-modal">
            ...
            <form action="" id="nuevo-formulario" class="nuevo-formulario">
                <input type="text" class="edit-texto-normal edit-cat-nombre" placeholder="Nombre de Categoría:">
                
                <p class="texto-cursiva">Ej.: Equipo de cómputo, Software, Mobiliario, etc.</p>
